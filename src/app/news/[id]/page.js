          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="lg:w-1/3">
              <div className="bg-gray-50 p-6 rounded-xl border border-gray-200">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900">{news.category}</p>
                  </div>
                </div>
              ...
              <div className="mt-6 text-center">
                <Link
                  href="/news"
                  className="inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors w-full"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-5 w-5 mr-2"
