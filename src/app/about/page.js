...
export default function About() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-24">
      {/* Hero Section */}
      <section className="text-center space-y-6 lg:mt-10">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-black leading-tight">
          About Daily News
        </h1>
        <p className="text-gray-700 text-base sm:text-lg md:text-xl lg:text-lg max-w-3xl mx-auto">
      ...
      <section className="grid md:grid-cols-2 gap-8 md:gap-12">
        <div className="p-6 sm:p-8 border border-gray-200 rounded-xl bg-white shadow-sm hover:shadow-lg transition transform hover:-translate-y-1">
          <h2 className="text-2xl sm:text-3xl font-semibold text-black mb-3 sm:mb-4">
            Our Mission
          </h2>
      ...
      <section className="space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 md:gap-10">
          {teamMembers.map((member) => (
            <div
              key={member.name}
              className="bg-white border border-gray-200 rounded-xl p-6 sm:p-8 text-center shadow-md hover:shadow-xl transform hover:-translate-y-1 hover:scale-105 transition-all duration-300"
            >
              ...
              <h3 className="font-bold text-lg sm:text-xl md:text-2xl text-black">
                {member.name}
              </h3>
      ...
      <section className="text-center space-y-4 sm:space-y-6">
        ...
        <Link
          href="/login"
          className="inline-block px-8 sm:px-10 py-2 sm:py-3 bg-black text-white font-semibold rounded-lg hover:bg-gray-800 transition"
        >
          Get Started
        </Link>
      </section>
